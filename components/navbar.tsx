  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span className="font-bold text-xl tracking-tighter">WrapAgency</span>
      </div>
      ...
      <div>
        <button className="px-4 py-2 rounded-full bg-white text-black font-medium text-sm hover:bg-white/90 transition-colors">
          Get Started
        </button>
      </div>
    </motion.nav>
