...
import { ArrowRight, Sparkles, BarChart3, Share2, Play } from "lucide-react";
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-32 pb-20 overflow-hidden">
      ...
      <div className="container px-4 mx-auto text-center z-10">
        ...
        >
          The future of client <br className="hidden md:block" /> reporting is here.
        </motion.h1>
        ...
        >
          Create interactive, &quot;Wrapped&quot;-style experiences for your clients. 
          Upload data, add media, and share stunning presentations in minutes.
        </motion.p>
        ...
        >
          <Link href="/make" className="group relative px-8 py-4 bg-white text-black rounded-full font-medium text-lg overflow-hidden transition-transform hover:scale-105">
            ...
            <div className="relative z-10 flex items-center justify-center gap-6 md:gap-12 p-8 w-full h-full">
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-zinc-900 to-black p-6 flex flex-col justify-center gap-4">
                  <div className="text-[10px] text-emerald-400 font-bold uppercase tracking-widest">Impressions</div>
                  <div className="text-5xl font-bold text-white font-display">247M</div>
                  <div className="text-xs text-white/60 leading-relaxed">
                    &quot;Your ads appeared enough times to fill Wembley Stadium 50x over&quot;
                  </div>
                  <div className="flex gap-1 mt-4">
                    <div className="px-2 py-1 bg-white/5 border border-white/10 rounded text-[8px] text-white/40">+42% vs 2024</div>
                    <div className="px-2 py-1 bg-white/5 border border-white/10 rounded text-[8px] text-white/40">3.8% CTR</div>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-violet-900/40 to-black p-0 flex flex-col">
                  ...
                  <div className="flex-1 p-6 flex flex-col justify-end gap-2">
                    <div className="text-lg font-bold text-white font-display leading-tight">9 major campaigns that drove wins</div>
                    <div className="text-[10px] text-violet-400 font-bold uppercase tracking-widest">Q3 SaaS Launch</div>
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-900/40 to-black p-6 flex flex-col justify-between">
                  <div className="space-y-4 pt-4">
                    ...
                    <div className="text-xl font-bold text-white font-display">London Growth Summit</div>
                    <div className="text-xs text-white/60">847 attendees | 92% NPS</div>
                  </div>
